              ...
              <div class="row">
                <div class="col-md-6 col-xl-4">
                  <div class="card shadow-none bg-transparent border border-secondary mb-3">
                    <div class="card-body">
                      <h5 style="text-align: center;" class="card-title">Autor</h5>
                        <h6 style="text-align: center;" class="card-text">Professor</h6>
                      <p style="text-align: center;"class="card-text">Enviado: 10/10/2022 10:53</p>
                      <hr>
                    <a href="#">  <h5 style="text-align: center;" class="card-title">ver</h5></a>
                    </div>
                  </div>
                </div>
              </div>
