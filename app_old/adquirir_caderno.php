...
>
  ...
  <body>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                      ...
                      -->
                          ...
                          <?php
                          require_once "Classes/PublicBook.php";
                          $c3 =  new PublicBook;
                          $c3->CadernoLojaUsuario($id_user, $_GET['caderno']);
    ...
    <div style="text-align: center;">
      <img src="../assets/img/plane.png" alt="Imagem" style="max-width: 20%; max-height: 20%;">
     <br> <h2>Seu caderno já está disponível.</h2><br>
     <a href="a/caderno.php?id=<?php echo $_GET['caderno'];?>"> <button type="button" class="btn rounded-pill btn-dark">Visualizar</button></a>
