...
$sexB;
$sabB;
// deixar ativo os campos com active show para ficar abrinco com a aba ativa
switch ($semana["$data"]) {
  case 'Domingo':
    $dom = date('d');
    $seg = date('d') + 1;
...
<div class="content-wrapper">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <!-- Layout Demo -->
    <!-- Pills -->
    <!-- <h5 class="py-3 my-4">Definir minha rotina</h5> -->

    <div class="row">
      <div class="col-xl-12">
        <!-- <h6 class="text-muted">*você pode definir sua r </h6> -->
        <div class="nav-align-top mb-4">
          <ul class="nav nav-pills mb-3" role="tablist">
            <li class="nav-item">
              <button
              type="button"
              class="nav-link <?php echo $domA; ?>"
              role="tab"
              data-bs-toggle="tab"
              data-bs-target="#dom"
              aria-controls="dom"
...
<div class="tab-content">
  <div class="tab-pane fade <?php echo $domB; ?>" id="dom" role="tabpanel">
    <p>
      <!-- Domingo -->

      <?php echo $dom . " de " . $mes_extenso["$mes"] . " de " . $ano; ?>
    </p>
    <p class="mb-0">
      <?php
      $novo = new Compromisso;
      $chave = $ano . "-" . date('m') . "-" . $dom . "%";
      $novo->MostrarCompromisso($chave);
      ?>
    </p>
  </div>
  <div class="tab-pane fade  <?php echo $segB; ?>" id="seg" role="tabpanel">
    <p>
      <?php echo $seg . " de " . $mes_extenso["$mes"] . " de " . $ano; ?>
    </p>
    <p class="mb-0">
      <?php
      $c1 = new Compromisso;
      $chave = $ano . "-" . date('m') . "-" . $seg . "%";
      $c1->MostrarCompromisso($chave);
      ?>
    </p>
  </div>
  <div class="tab-pane fade  <?php echo $terB; ?>" id="ter" role="tabpanel">
    <p>
      <?php echo $ter . " de " . $mes_extenso["$mes"] . " de " . $ano; ?>
    </p>
    <p class="mb-0">
      <?php
      $c1 = new Compromisso;
      $chave = $ano . "-" . date('m') . "-" . $ter . "%";
      $c1->MostrarCompromisso($chave);
      ?>
    </p>
  </div>
  <div class="tab-pane fade  <?php echo $quaB; ?>" id="qua" role="tabpanel">
    <p>
      <?php echo $qua . " de " . $mes_extenso["$mes"] . " de " . $ano; ?>
    </p>
    <p class="mb-0">
      <?php
      $c1 = new Compromisso;
      $chave = $ano . "-" . date('m') . "-" . $qua . "%";
      $c1->MostrarCompromisso($chave);
      ?>
    </p>
  </div>
  <div class="tab-pane fade  <?php echo $quiB; ?>" id="qui" role="tabpanel">
    <p>
      <?php echo $qui . " de " . $mes_extenso["$mes"] . " de " . $ano; ?>
    </p>
    <p class="mb-0">
      <?php
      $c1 = new Compromisso;
      $chave = $ano . "-" . date('m') . "-" . $qui . "%";
      $c1->MostrarCompromisso($chave);
      ?>
    </p>
  </div>
  <div class="tab-pane fade  <?php echo $sexB; ?>" id="sex" role="tabpanel">
    <p>
      <?php echo $sex . " de " . $mes_extenso["$mes"] . " de " . $ano; ?>
    </p>
    <p class="mb-0">
      <?php
      $c1 = new Compromisso;
      $chave = $ano . "-" . date('m') . "-" . $sex . "%";
      $c1->MostrarCompromisso($chave);
      ?>
    </p>
  </div>
  <div class="tab-pane fade  <?php echo $sabB; ?>" id="sab" role="tabpanel">
    <p>
      <?php echo $sab . " de " . $mes_extenso["$mes"] . " de " . $ano; ?>
    </p>
    <p class="mb-0">
      <?php
      $c1 = new Compromisso;
      $chave = $ano . "-" . date('m') . "-" . $sab . "%";
      $c1->MostrarCompromisso($chave);
      ?>
    </p>
  </div>
...
<form class="" action="a/sucess.php" method="post">
  <input type="hidden" id="tipo" value="1" name="idpage">
  <input type="hidden" id="tipo" value="<?php echo $id_user; ?>" name="usuariocompromisso">
  <div class="row">
    <div class="col-md-12">
      <div class="card mb-4">
        <h5 class="card-header">Novo compromisso</h5>
        <div class="card-body">
          <div>
            <label for="defaultFormControlInput" class="form-label">*Nome do compromisso novo</label>
            <input
            type="text"
            class="form-control"
            ...
            <div id="defaultFormControlHelp" class="form-text">
              Ficará definido sem possibilidade de edição!
              <br>
            </div>

            <input class="form-control" type="datetime-local" value="" name="datacompromisso" required id="html5-datetime-local-input">
            <br>
            <button type="submit" class="btn btn-dark">Definir</button>
          </div>
        </div>
      </div>
    </div>
