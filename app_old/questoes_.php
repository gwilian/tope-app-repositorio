...
<!-- beautify ignore:start -->
 ...
 <!-- Modal -->
        ...
        <div class="container">
          <h2>Área de Testes da #tope - platafotma</h2> <p><b>etapa:</b>estamos otimizando os filtros</p>
    <br><br><br>  <span id="conteudo"></span>
    <hr>
        </div>
...
<div class="modal-content">
<div class="modal-header">
<h5 class="modal-title" id="modalScrollableTitle">Comentários sobre a questão</h5>
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>

<input type="hidden" id="data" name="data" value="<?php echo $current_date; ?>">
  <input type="hidden" id="nome_usuario" name="nome_usuario" value="<?php echo $user_tp; ?>">
    <input type="hidden" id="id_usuario" name="id_usuario" value="<?php echo $id_user; ?>">
    <input type="hidden" id="ultima_questao" value="">



<div class="modal-body">
          <div>
          <label for="comentario" class="form-label">Adicionar novo comentário:</label>
          <textarea class="form-control" id="comentario" rows="3" style="height: 93px;"></textarea>
        </div><br><hr>
...
<button type="button" id="submit-question" onclick="novoComentario()" class="btn btn-primary">Enviar comentário</button>
    ...
    <script>
      ...
      function listar_usuario(pagina, qnt_result_pg){
        ...
        $.post('Classes/navegar_questoes.php', dados , function(retorna){
    ...
    <script src="../assets/js/corrigir_q.js"></script>


    <script type="text/javascript">
    function modal(n) {
      var input = document.getElementById("ultima_questao");
      input.value = n;
      $("#modalScrollable").modal('toggle');
      var container = document.getElementById("comments-container");
      container.innerHTML  = "";
      $.ajax({
        url: 'Classes/comentario_questao.php',
        type: 'post',
        data: {value: n},
        success: function(response) {
          ...
          for (var i = 0; i < comments.length; i++) {
            container.innerHTML += "<div class=\"d-flex mb-3\"> <div class=\"flex-shrink-0\"> <img src=\"../assets/img/avatars/1.png\"  class=\"me-3\" height=\"40\"> </div> <div class=\"flex-grow-1 row\"> <div class=\"col-9 mb-sm-0 mb-2\"> <h6 class=\"mb-0\">"+comments[i].usuario+" #"+comments[i].id_usuario+"</h6> <strong>"+comments[i].comentario+"</strong> <br> <small><i>~"+comments[i].data+"~</i></small> </div> </div> </div><hr>";
          }
    ...
    function novoComentario() {
      var id = document.getElementById("ultima_questao");
         var n = id.value; //ok

      var comentario = document.getElementById("comentario");
        var text_comentario = comentario.value; //ok

      var data = document.getElementById("data");
      var text_data = data.value; //ok

      var nome_usuario = document.getElementById("nome_usuario");
      var text_nome_usuario = nome_usuario.value; // ok

      var id_usuario = document.getElementById("id_usuario");
      var text_id_usuario = id_usuario.value; //ok

      $.ajax({
        type: "POST",
        url: "Classes/comentario_questao.php",
        data: { text_comentario: text_comentario, n: n, text_nome_usuario: text_nome_usuario, text_id_usuario: text_id_usuario, text_data: text_data },
        success: function(response) {
          var comentario = document.getElementById("comentario");
          comentario.value  = "";
          var container = document.getElementById("comments-container");
          container.innerHTML += "<div class=\"d-flex mb-3\"> <div class=\"flex-shrink-0\"> <img src=\"../assets/img/avatars/1.png\"  class=\"me-3\" height=\"40\"> </div> <div class=\"flex-grow-1 row\"> <div class=\"col-9 mb-sm-0 mb-2\"> <h6 class=\"mb-0\">"+text_nome_usuario+" #"+text_id_usuario+"</h6> <strong>"+text_comentario+"</strong> <br> <small><i>~"+text_data+"~</i></small> </div> </div> </div><hr>";
          }
        });
        }
        ...
        function video(n){
          ...
          if (n == "") {
              video.innerHTML = "<br> <h3>Desculpe, ainda não há video para esta questão.</h3> <br>";
          }else {
            video.innerHTML =    "<iframe width=\"727\" height=\"409\" src="+n+"  frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe>";
