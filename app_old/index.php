              ...
              <div class="d-flex justify-content-between flex-sm-row flex-column gap-2">
                <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                  <div class="card-title">
                    ...
                    <span class="badge bg-label-warning rounded-pill">Cadernos</span>
                  </div>
      ...
      <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
        <div class="card">
          <div class="row row-bordered g-0">
            <div class="col-md-8">
              <h5 class="card-header m-0 me-2 pb-3">Estudo / Revisão</h5>
            ...
            <div class="text-center fw-semibold pt-3 mb-2">Rendimento hoje</div>

            <div class="d-flex px-xxl-4 px-lg-2 p-4 gap-xxl-3 gap-lg-1 gap-3 justify-content-between">
              <div class="d-flex">
                <div class="me-2">
                  <span class="badge bg-label-primary p-2"><i class="bx bxs-book text-primary"></i></span>
                </div>
              ...
              <div class="d-flex">
                <div class="me-2">
                  <span class="badge bg-label-info p-2"><i class="bx bx-book-reader text-info"></i></span>
                </div>
                <div class="d-flex flex-column">
                  <small>Revisão</small>
                  <h6 class="mb-0">0</h6>
    ...
    <div class="col-md-6 col-lg-4 order-2 mb-4">
      ...
      <div class="card-body">
        <ul class="p-0 m-0">
          <li class="d-flex mb-4 pb-1">
            ...
            <div  class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              ...
              <a href="a/erros_acertos.php?status=errou"> <small class="text-muted d-block mb-1">Questões/</small>
                <h6 class="mb-0">Erros</h6></a>
              </div>
              <div class="user-progress d-flex align-items-center gap-1">
                <h6 class="mb-0"><?php
                $c3 = new RoboZe;
                $c3->ContarErros($id_user); ?></h6>
          ...
          <li class="d-flex mb-4 pb-1">
            <div class="avatar flex-shrink-0 me-3">
              <img src="../assets/img/icons/unicons/videos.png" alt="User" class="rounded" />
            </div>
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              <div class="me-2">
