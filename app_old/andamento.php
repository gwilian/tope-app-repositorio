...
>
  ...
  ██ ██   ████ ██  ██████ ██  ██████
     ...
     <!-- <h6 class="pb-1 mb-4 text-muted">Chamados em andamento</h6> -->
     
                  <div class="row mb-5">

                   <!-- <p class="pb-1 mb-4 text-muted"></p> -->
                    
                      <small class="text-light fw-semibold">*Nesta aba todas as solicitações permanecerão bloqueadas, aguardando resposta do suporte interno.</small>
                      <div class="demo-inline-spacing mt-3">
                        ...
                        <!-- <a href="javascript:void(0);" class="list-group-item list-group-item-action flex-column align-items-start active">
                            ...
                            $c2 = new Adm;
                            $c2->ListarResumosCaderno($id_user);
                            ?>
