...
<!-- Style variation -->
          <center>   <h5 class="pb-1 mb-4">Solicitações respondidas</h5> </center>
             <div class="row">

               <div class="col-md-6 col-xl-4">
                 <div class="card bg-success text-white mb-3">
                   <div class="card-header">resposta: 15/04/2022</div>
                   <div class="card-body">
                     <h5 class="card-title text-white">Biologia</h5>
                     <p class="card-text">resposta equivoca com o livro e material de aula, no entanto....</p>
                     <hr>
