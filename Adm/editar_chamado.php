 ...
 <!-- Modal -->
        ...
        -->
                ...
                <form action="sucess.php" method="POST">
                      ...
                      $c2 = new Adm;
                      $c2->EditarChamados($_GET['id']);
                      ?>
                    
                      
                     <textarea required aria-invalid="true" title="Por favor, preencha este campo." id="mytextarea" name="relatorio" > </textarea>
                     <input type="hidden" name="send" value="true">
                     <button type="submit" class="btn btn-primary mx-auto d-block">Responder</button>
                     </form>
                  </div>
                </div>
                </div>
