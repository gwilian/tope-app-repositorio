...
<!-- beautify ignore:start -->
 ...
 <head>
   ...
   />
<meta property="og:image" content="https://topeestudos.com/questao/aprovado.png">
<meta property="og:title" content="Tope - Plataforma de estudos | Questão">
<meta property="og:description" content="Tope - Sua plataforma de questões, materiais, mentorias redações | sua aprovação começa aqui.">
<meta property="og:type" content="article">
<meta property="og:site_name" content="Tope">
<meta property="og:locale" content="pt_BR">
<meta name="twitter:card" content="summary_large_image">
<meta name="robots" content="resolver.php, follow">
  ...
  <meta name="description" content="<?php $c2->Enunciado($_GET['hash']); ?>">
...
<!-- Dashboard -->
<li class='menu-item'>
 <a href='#'  data-bs-toggle='modal' data-bs-target='#modalCenter'  class='menu-link' >
 ...
 <!-- Modal -->
  ...
  <div class="card">
              <div class="d-flex align-items-end row">
                <div class="col-sm-7">
                  <div class="card-body">
                    <h5 class="card-title text-primary">Alô você! NOVA plataforma de estudos!</h5>
                    <p class="mb-4" style="color:black;">
                      Agora com a TOPE são mais de  <span class="fw-bold">2 Milhões de questões!</span> corre e increva-se agora, não perca tempo!
                    </p>
                ...
                <div class="col-sm-5 text-center text-sm-left">
                  <div class="card-body pb-0 px-0 px-md-4">
                    <img src="../assets/img/backgrounds/banner_questoes.png" height="140" alt="View Badge User" data-app-dark-img="illustrations/man-with-laptop-dark.png" data-app-light-img="illustrations/man-with-laptop-light.png">
                  </div>
                </div>
              </div>
            </div>
         ...
         <?php 
          // echo $conectado;
          echo "<input type='hidden' id='conectado' value='$conectado' >";
          $c2->mostrarQuestao($_GET['hash']); ?>
          ...
          <!-- Modal vertical e centralizado -->
                        <div class="modal fade" id="modalCenter" tabindex="-1" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalCenterTitle">Ops! Você ainda não está registrado!😥</h5> <br>
                              ...
                              <p class="mx-4">para acessar todos os recursos da plataforma você precisa estar logado!</p>
                              <p class="mx-4">ao clicar nos links, uma <b style="color:#696cff;">nova guia</b> será aberta, você poderá <b style="color:#696cff;">voltar</b> e <b style="color:#696cff;">atualizar a página!</b></p>
                              <div class="modal-body">
                                <div class="row">
                                 <div class="d-grid gap-2 col-lg-6 mx-auto ">
                                 <!-- <a href="../app/auth-entrar.php" target="_blank"> <button type="button" class="btn btn-lg rounded-pill btn-primary">Entrar</button></a> -->
                                 <a href=""  onclick="login();"> <button type="button" class="btn btn-lg rounded-pill btn-primary">Entrar</button></a>
                                </div>
                                </div>
                                <div class="row">
                                    <div class="d-grid gap-2 col-lg-6 mx-auto mt-3">
                                <!-- <a href="../inicio/conhecer/" target="_blank"> <button type="button" class="btn btn-lg rounded-pill btn-primary">Cadastre-se</button></a> -->
                                <a href=""  onclick="registro();"> <button type="button" class="btn btn-lg rounded-pill btn-primary">Cadastre-se</button></a>
                                </div>
...
-->
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  , desenvolvido ❤️ pelo
                  <a href="https://www.instagram.com/tope_estudos/" target="_blank" class="footer-link fw-bolder">Time #Tope</a>
                </div>
                <div>
    ...
    <div class="buy-now">
      <a href="../app/questoes_filtro.php"class="btn btn-danger btn-buy-now">Questões</a>
    </div>
    ...
    <script src="../assets/js/main.js"></script>
     <script src="processar_questao.js"></script>
    <!-- Page JS -->
<script>
function login() {
  var url = "../app/auth-entrar.php";
  var windowFeatures = "menubar=no,toolbar=no,status=no";
  window.open(url, "_blank", windowFeatures);
}


function registro() {
  var url = "../inicio/conhecer/";
  var windowFeatures = "menubar=no,toolbar=no,status=no";
  window.open(url, "_blank", windowFeatures);
}
...
function verificarUsuarioLogado() {
    ...
    if (xhr.readyState === 4) {
      if (xhr.status === 200) {
        ...
        if (resposta === "true") {
         ...
         document.getElementById('conectado').value = 'true';
        } else {
  ...
  xhr.open("GET", "verifica_login.php", true);
  xhr.send();
}

// Verificar a cada 5 segundos (5000 milissegundos)
setInterval(verificarUsuarioLogado, 5000);
