...
<h3 style="text-align: center;">Você ainda não possui nenhuma turma...</h3>
<!-- Outline -->
<div class="row">
 <div class="col-md-6 col-xl-4">
   <div class="card shadow-none bg-transparent border border-secondary mb-3">
     <div class="card-body">
       <h5 style="text-align: center;" class="card-title">Turma ENEM - 4215</h5>
       <p class="card-text">turma foco enem e redação 2022</p>
       <hr>
     <a href="#">  <h5 style="text-align: center;" class="card-title">Entrar</h5></a>
     </div>
   </div>
 </div>
</div>
