...
<!-- Style variation -->
            <center> <h5 class="pb-1 mb-4">Solicitações arquivadas</h5> </center>
             <div class="row">
               ...
               <div class="col-md-6 col-xl-4">
                 <div class="card bg-secondary text-white mb-3">
                   ...
                   <div class="card-body">
                     <h5 class="card-title text-white">resolução do exercio 03</h5>
                     <p class="card-text">ao tentar solução para o exercicio 03 não consegui...</p>
                     <hr>
                    <center>  <p class="card-text">ver</p> </center>
                   </div>
                 </div>
               </div>
