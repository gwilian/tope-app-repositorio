...
<div class="content-wrapper">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <!-- Style variation -->
    <h5 class="pb-1 mb-4">Solicitações ainda não respondidas</h5>
    <div class="row">
      <div class="col-md-6 col-xl-4">
        <div class="card bg-primary text-white mb-3">
          <div class="card-header">Enviada: 10/12/2022</div>
          <div class="card-body">
            <h5 class="card-title text-white">Matemática</h5>
            <p class="card-text">Plano cartesiano, as coodenadas repassadas pelo exercicio não conferem com as alternativas do...</p>
            <hr>
            <center> <p class="card-text">Abrir</p></center>
          </div>
        </div>
      </div>
