        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Configurações da conta /</span> Usuário</h4>
              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="perfil2.php"
                        ><i class="bx bx-bell me-1"></i> Alertas</a
                      >
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="perfil3.php"
                        ><i class="bx bx-link-alt me-1"></i> Integrações</a
                      >
                    </li>
                  </ul>
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        ...
                        <div class="button-wrapper">
                          ...
                          <p class="text-muted mb-0">Permitidos: JPG, GIF or PNG. Maximo tamanho de 1.5Mb</p>
                        </div>
                      </div>
                    </div>
                    <hr class="my-0" />
                    <div class="card-body">
                      <form id="formAccountSettings" method="POST" onsubmit="return false">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="organization" class="form-label">Escola/Inst. de ensino</label>
                            <input
                              type="text"
                              class="form-control"
                              id="organization"
                        ...
                        <div class="mt-2">
                          <button type="submit" class="btn btn-primary me-2">Salvar definições</button>
                    ...
                    <div class="card-body">
                      <div class="mb-3 col-12 mb-0">
                        <div class="alert alert-warning">
                          <h6 class="alert-heading fw-bold mb-1">Tem certeza que quer deletar sua conta?</h6>
                          <p class="mb-0">Sua solicitação vai para um centro de aprovação,somente após 30 dias será liberado novo acesso nas mesmas credenciais.</p>
                        </div>
                      </div>
                      <form id="formAccountDeactivation" onsubmit="return false">
                        <div class="form-check mb-3">
                          ...
                          <label class="form-check-label" for="accountActivation"
                            >Eu aceitos os termos e prefiro deletar minha conta assim mesmo.</label
                          >
                        </div>
