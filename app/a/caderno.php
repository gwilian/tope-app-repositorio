...
<div class="content-wrapper">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <!-- Layout Demo -->
    <!-- Tabs -->
    <!-- <h5 class="py-3 my-4">Nome do Meu caderno</h5> -->
...
<?php 
$c3 = new Caderno;
      $c3->ListarCadernosLojaEditar($_GET['id'], $id_user);

?>

<br>
      <div class="col-xl-12">
        <!-- <h6 class="text-muted">@nome do autor</h6> -->
        <div class="nav-align-top mb-4">
          <ul class="nav nav-tabs nav-fill" role="tablist">
            <li class="nav-item">
              ...
              aria-selected="true"
              >
              <i class="tf-icons bx bx-home"></i> Material
              <span class="badge rounded-pill badge-center h-px-20 w-px-20 bg-label-danger"><?php 
                                                                                            $c3->ContarMaterias($_GET['id']); ?></span>
            </button>
          </li>
          <li class="nav-item">
            <button
            ...
            aria-selected="false"
            >
            <i class="tf-icons bx bx-user"></i> Resumos
          </button>
        </li>
        <li class="nav-item">
          <button
          ...
          aria-selected="false"
          >
          <i class="tf-icons bx bx-message-square"></i> Atividades
        </button>
      </li>
      <li class="nav-item">
        <button
        ...
        role="tab"
        data-bs-toggle="tab"
        data-bs-target="#navs-justified-messages1"
        aria-controls="navs-justified-messages1"
        aria-selected="false"
        >
        <i class="tf-icons bx bx-message-square"></i> Tasks
      </button>
    </li>
  </ul>
  <div class="tab-content">
    <div class="tab-pane fade show active" id="navs-justified-home" role="tabpanel">
      ...
      <?php
      $c2 = new Caderno;
      $c2->ListarMaterias($_GET['id']);
      ?>
    </div>
    <div class="tab-pane fade" id="navs-justified-profile" role="tabpanel">
      <?php
      $c2 = new Caderno;
      $c2->ListarResumosCaderno($_GET['id']);
      ?>
    </div>
    <div class="tab-pane fade" id="navs-justified-messages" role="tabpanel">
      <?php
      $c2 = new Caderno;
      $c2->ListarAtividadeCaderno($_GET['id']);
      ?>
    </div>
    <div class="tab-pane fade" id="navs-justified-messages1" role="tabpanel">
      <?php
      $c2 = new Caderno;
      $c2->ListarTasksCaderno($_GET['id']);
      ?>
    </div>
  </div>
</div>
