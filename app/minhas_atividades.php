...
██ ██   ████ ██  ██████ ██  ██████
   ...
   <h6 class="pb-1 mb-4 text-muted">Lista de exercícios vinculados ao meu usuário, pendentes de realização.</h6>
                <div class="row mb-5">
                  <div class="col-md-6 col-lg-4 mb-3">
                    <div class="card text-center">
                      <div class="card-header">01/05/2022</div>
                      <div class="card-body">
                        <h5 class="card-title">Biologia</h5>
                        <p class="card-text">Origem das espécies cap-01, a origem evolutiva das espécies segundo Lamarck e Darwin.</p>
                        <a href="javascript:void(0)" class="btn btn-primary">Iniciar</a>
                      </div>
                      <div class="card-footer text-muted">Encerra em 15/05/2022</div>
                    </div>
                  </div>
                </div>
                <!--/ Content types -->
