          ...
          <div class="col-lg-12 mb-4 order-0">
            <div class="card">
              <div class="d-flex align-items-end row">
                <div class="col-sm-7">
                  <div class="card-body">
                    <h5 class="card-title text-primary">Você pode criar um novo caderno ✔</h5>
                    <p class="mb-4">
                      Sim! você pode criar um caderno e definir seu próprio material, definindo bem qual será seu <span class="fw-bold">Foco!</span>.
                    </p>

                    <a href="javascript:;"  data-bs-toggle="modal"
                    data-bs-target="#basicModal" class="btn btn-sm btn-outline-primary">Criar novo caderno</a>
                  </div>
                </div>
...
-->
          ...
          <!-- Horizontal -->
             <h5 class="pb-1 mb-4">Cadernos criados:</h5>
   <div class="row row-cols-1 row-cols-md-3 mt-2 g-4 mb-5">
               <?php
                $novo = new Caderno;
                $novo->ListarCadernos($id_user);
                $novo->ListarCadernosLoja($id_user);
