                ...
                <div class="col-lg-8 mb-4 order-0">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary">Olá, <?php echo $_SESSION['nome']; ?> 😎</h5>
                          <p class="mb-4">
                          "A possibilidade de realizarmos um sonho é o que torna a vida interessante." ~ Paulo Coelho
                          </p>

                          <a href="javascript:;" class="btn btn-sm btn-outline-primary">Download Manual da plataforma</a>
                        </div>
                      </div>
                      <div class="col-sm-5 text-center text-sm-left">
                        <div class="card-body pb-0 px-0 px-md-4">
                          <img
                            ...
                            height="140"
                            alt="View Badge User"
                            data-app-dark-img="../assets/img/illustrations/conhecimento.gif"
                            data-app-light-img="../assets/img/illustrations/conhecimento.gif"
                          />
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="fw-semibold d-block mb-1">Questões resolvidas</span>
                          <h3 class="card-title mb-2"><?php $result->ResultadoGeral($id_user); ?> </h3>
                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <img
                                src="../assets/img/icons/unicons/trofeu.png"
                                alt="Credit Card"
                                class="rounded"
                              />
                            </div>
                          ...
                          <span>Pontuação</span>
                          <h3 class="card-title text-nowrap mb-1" id="pontuacao"></h3>
                          <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i></small>
                        </div>
                      </div>
                    </div>
                ...
                <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-8">
                        <h5 class="card-header m-0 me-2 pb-3">Questões (Acertos x Erros) - 07 dias</h5>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <img src="../assets/img/icons/unicons/ok.png" alt="Credit Card" class="rounded" />
                            </div>
                            <div class="dropdown">
                              <button
                                class="btn p-0"
                          ...
                          <span class="d-block mb-1">Acertos</span>
                          <h3 class="card-title text-nowrap mb-2" id="acerto"> <?php $result->ResultadoTotal("Acertou", $id_user); ?></h3>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <img src="../assets/img/icons/unicons/error.png" alt="Credit Card" class="rounded" />
                            </div>
                            <div class="dropdown">
                              <button
                                class="btn p-0"
                          ...
                          <span class="fw-semibold d-block mb-1">Erros</span>
                          <h3 class="card-title mb-2" id="erro" ><?php $result->ResultadoTotal("Errou", $id_user); ?></h3>
                          <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i></small>
                        </div>
                      </div>
                    </div>
                          ...
                          <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                            <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                              <div class="card-title">
                                <h5 class="text-nowrap mb-2">Evolução</h5>
                                <span class="badge bg-label-warning rounded-pill">07 dias</span>
                              </div>
                              <div class="mt-sm-auto">
                                <small class="text-success text-nowrap fw-semibold"
                                  ><i class="bx bx-chevron-up"></i>(por acertos)</small
                                >
                                <h3 class="mb-0"></h3>
                              </div>
                            </div>
...
, desenvolvido ❤️ por
<a href="https://themeselection.com" target="_blank" class="footer-link fw-bolder">Time #Tope</a>
</div>
<div>
