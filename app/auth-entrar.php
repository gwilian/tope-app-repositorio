...
if (isset($_GET['response'])) {
  $status = $_GET['response'] ? "Senha incorreta" : "";
} else {
  $status = "";
}
...
>
  <head>
    ...
    <title>( Login ) Tope - sua plataforma de estudos</title>
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  <span class="app-brand-logo demo">
                   <svg version="1.1" id="Layer_1" width="25" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">#Tope</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Oie, tudo bem? que bom te ver! </h4>
              <p class="mb-4">Estamos organizando todo seu material na bancada pra você 🖥📖🖊</p>
              ...
              if (isset($_GET['r'])) {
                if($_GET['r'] == 1){
                echo "<div class='bs-toast toast toast-placement-ex m-2 fade bg-primary top-0 start-0 show' role='alert' aria-live='assertive' aria-atomic='true' data-delay='2000'>
                <div class='toast-header'>
                  <i class='bx bxs-graduation me-2'></i>
                  <div class='me-auto fw-semibold'>Bem Vindo! 😎</div>
                  <small>01 min</small>
                  <button type='button' class='btn-close' data-bs-dismiss='toast' aria-label='Close'></button>
                </div>
                <div class='toast-body'>Sua conta foi registrada com sucesso! parece que você recebeu um código promocional especial!!.</div>
              </div>";
                }
              } else {
                # code...
              ...
              <form id="formAuthentication" class="mb-3" action="a/auth2.php" method="POST">
                <input type="hidden" name="id_post" value="2">
                <div class="mb-3">
                ...
                <div class="mb-3 form-password-toggle">
                  ...
                  <p style="color: #FF2B08;" ><?php echo $status; ?></p>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <button id="botao" class="btn btn-primary d-grid w-100" type="submit">Entrar</button>
                </div>
              </form>
              <p class="text-center">
                <span>Novo por aqui?</span>
                <!-- <a href="auth-registro.php"> -->
                   <a href="../inicio/conhecer/">
        ...
        xmlhttp.onreadystatechange = function() {
          if (this.readyState == 4 && this.status == 200) {
           ...
           if (this.responseText != "true") {
            document.getElementById("mostrar").innerHTML = "Verifique seu email";
