          ...
          <div class="col-lg-12 mb-4 order-0">
            <div class="card">
              <div class="d-flex align-items-end row">
                <div class="col-sm-7">
                  <div class="card-body">
                    <h5 class="card-title text-primary">São mais de 2 Milhões que questões!!</h5>
                    <p class="mb-4">
                      Conheça nossa inteligência artificial integrada que vai te ajudar a obter o melhor <span class="fw-bold">desenpenho!</span>.
                    </p>

                    <a href="questoes_.php"  data-bs-toggle="modal"
                    data-bs-target="#basicModal" class="btn btn-sm btn-outline-primary">Conhecer</a>
                  </div>
                </div>
                <div class="col-sm-5 text-center text-sm-left">
                  <div class="card-body pb-0 px-0 px-md-4">
                    <img
                      src="../assets/img/backgrounds/banner_questoes.png"
                      height="140"
                      alt="View Badge User"
...
<div class="container">
  <div class="row px-4">
    <div class="card mb-4">
      <div class="card-body d-flex justify-content-center mb-0">
        <button type="button" data-bs-toggle="modal" data-bs-target="#MODAL1" class="btn btn-outline-primary btn-custom mx-1">
          <span class="tf-icons bx bx-folder mx-2"></span>&nbsp; Disciplina
        </button>
        <button type="button"  data-bs-toggle="modal" data-bs-target="#MODAL2" class="btn btn-outline-primary btn-custom mx-1">
          <span class="tf-icons bx bx-folder-open mx-2"></span>&nbsp; Assunto
        </button>
        <button type="button"  data-bs-toggle="modal" data-bs-target="#MODAL3" class="btn btn-outline-primary btn-custom mx-1">
          <span class="tf-icons bx bxs-directions mx-2"></span>&nbsp; Banca
        </button>
        <button type="button"  data-bs-toggle="modal" data-bs-target="#MODAL4" class="btn btn-outline-primary btn-custom mx-1">
          <span class="tf-icons bx bxs-landmark mx-2"></span>&nbsp; Instituição
        </button>
        <button type="button"  data-bs-toggle="modal" data-bs-target="#MODAL5" class="btn btn-outline-primary btn-custom mx-1">
          <span class="tf-icons bx bxs-user-check mx-2"></span>&nbsp; Cargo
        </button>
      ...
      <div class=" d-flex justify-content-center mb-4">
        <button type="button" data-bs-toggle="modal" data-bs-target="#MODAL6" class="btn btn-outline-primary btn-custom mx-1">
          <span class="tf-icons bx bxs-calendar mx-2"></span>&nbsp; Ano
        </button>
        <button type="button" data-bs-toggle="modal" data-bs-target="#MODAL7" class="btn btn-outline-primary btn-custom mx-1">
          <span class="tf-icons bx bxs-bank mx-2"></span>&nbsp; Carreira
        </button>
        <button type="button" data-bs-toggle="modal" data-bs-target="#MODAL8" class="btn btn-outline-primary btn-custom mx-1">
          <span class="tf-icons bx bxs-graduation mx-2"></span>&nbsp; Area de formação
        </button>
        <button type="button" data-bs-toggle="modal" data-bs-target="#MODAL9" class="btn btn-outline-primary btn-custom mx-1">
          <span class="tf-icons bx bxs-graduation mx-2"></span>&nbsp; Escolaridade
        </button>
        <button type="button" data-bs-toggle="modal" data-bs-target="#MODAL10" class="btn btn-outline-primary btn-custom mx-1">
          <span class="tf-icons bx bx-line-chart mx-2 "></span>&nbsp; Dificuldade
        </button>
                        ...
                        <div class="d-grid gap-2 col-lg-6 mx-auto mb-4">
                            <button class="btn btn-primary btn-lg" type="button">
                                <span class="tf-icons bx bxs-search mx-2 "></span>&nbsp; Filtrar questões
                            </button>
...
<!-- linha 02 -->
                      ...
                      <div class="modal fade" id="MODAL1" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel3"><span class="tf-icons bx bx-folder mx-2"></span>&nbsp; Disciplina</h5>
                              <button
                                type="button"
                                class="btn-close"
                                data-bs-dismiss="modal"
                            ...
                            <input type="text" class="form-control col mr-2" name="termo" id="termo" placeholder="Digite aqui e clique em buscar..." />
                            <button name="salvar" id="salvar" type="submit" class="btn btn-primary ml-3">
                              <span class="tf-icons bx bx-search-alt-2 mx-2 "></span>&nbsp; Buscar
                            </button>
                          </div>
                              ...
                              <!-- INSERIR DADOS DA BUSCA -->
                              <!-- <div class="form-check mt-3">
                          <input class="form-check-input" type="checkbox" value="" id="defaultCheck1">
                          <label class="form-check-label" for="defaultCheck1"> <span class="tf-icons bx bx-folder mx-2"></span>&nbsp; Disciplina</label>
                        </div> -->

                        <div id="resultados"></div>
                        <button id="exibir-mais" class="btn btn-primary mt-3"  >Exibir mais</button>
                            ...
                            <div class="modal-footer">
                              ...
                              <button type="submit"  value="Enviar" onclick="mostrarConteudo()" class="btn btn-primary">Salvar</button>
                            </div>
                          </div>
                        </div>
                      </div>
  ...
  <div class="modal fade" id="MODAL2" tabindex="-1" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col mb-3 d-flex align-items-center">
        <input type="text" class="form-control col mr-2" name="termo2" id="termo2" placeholder="Digite aqui e clique em buscar..." />
        <button name="salvar2" id="salvar2" type="submit" class="btn btn-primary ml-3">
          <span class="tf-icons bx bx-search-alt-2 mx-2 "></span>&nbsp; Buscar
        </button>
      </div>
    ...
    <button id="exibir-mais2" class="btn btn-primary mt-3"  >Exibir mais</button>
        ...
        <div class="modal-footer">
          ...
          <button type="submit"  value="Enviar" onclick="mostrarConteudo2()" class="btn btn-primary">Salvar</button>
        </div>
      </div>
    </div>
  </div>
      ...
      <!-- MODAL 3 -->
                          <div class="modal fade" id="MODAL3" tabindex="-1" aria-hidden="true">
                              <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel3"><span class="tf-icons bx bxs-directions mx-2"></span>&nbsp; Banca</h5>
                                    <button
                                      type="button"
                                      class="btn-close"
                                      data-bs-dismiss="modal"
                                  ...
                                  <div class="modal-body">
                                    <div class="row">
                                      <div class="col mb-3 d-flex align-items-center">
                                  <input type="text" class="form-control col mr-2" placeholder="Digite aqui e clique em buscar..." />
                                      ...
                                      Sair
                                            ...
                                            <div class="modal fade" id="MODAL4" tabindex="-1" aria-hidden="true">
                                                                    <div class="modal-dialog modal-lg" role="document">
                                                                      <div class="modal-content">
                                                                        <div class="modal-header">
                                                                          <h5 class="modal-title" id="exampleModalLabel3"><span class="tf-icons bx bxs-landmark mx-2"></span>&nbsp; Instituição</h5>
                                                                          <button
                                                                            type="button"
                                                                            class="btn-close"
                                                                            data-bs-dismiss="modal"
                                                                  ...
                                                                  <div class="modal fade" id="MODAL5" tabindex="-1" aria-hidden="true">
                                                                                          <div class="modal-dialog modal-lg" role="document">
                                                                                            <div class="modal-content">
                                                                                              <div class="modal-header">
                                                                                                <h5 class="modal-title" id="exampleModalLabel3"><span class="tf-icons bx bxs-user-check mx-2"></span>&nbsp; Cargo</h5>
                                                                                                <button
                                                                                                  type="button"
                                                                                                  class="btn-close"
                                                                                                  data-bs-dismiss="modal"
                                                                                        ...
                                                                                        <div class="modal fade" id="MODAL6" tabindex="-1" aria-hidden="true">
                                                                                                                <div class="modal-dialog modal-lg" role="document">
                                                                                                                  <div class="modal-content">
                                                                                                                    <div class="modal-header">
                                                                                                                      <h5 class="modal-title" id="exampleModalLabel3">  <span class="tf-icons bx bxs-calendar mx-2"></span>&nbsp; Ano</h5>
                                                                                                                      <button
                                                                                                                        type="button"
                                                                                                                        class="btn-close"
                                                                                                                        data-bs-dismiss="modal"
                                                                                                              ...
                                                                                                              <div class="modal fade" id="MODAL7" tabindex="-1" aria-hidden="true">
                                                                                                                                      <div class="modal-dialog modal-lg" role="document">
                                                                                                                                        <div class="modal-content">
                                                                                                                                          <div class="modal-header">
                                                                                                                                            <h5 class="modal-title" id="exampleModalLabel3">  <span class="tf-icons bx bxs-bank mx-2"></span>&nbsp; Carreira</h5>
                                                                                                                                            <button
                                                                                                                                              type="button"
                                                                                                                                              class="btn-close"
                                                                                                                                              data-bs-dismiss="modal"
                                                                                                                                    ...
                                                                                                                                    <div class="modal fade" id="MODAL8" tabindex="-1" aria-hidden="true">
                                                                                                                                                            <div class="modal-dialog modal-lg" role="document">
                                                                                                                                                              <div class="modal-content">
                                                                                                                                                                <div class="modal-header">
                                                                                                                                                                  <h5 class="modal-title" id="exampleModalLabel3">  <span class="tf-icons bx bxs-graduation mx-2"></span>&nbsp; Area de formação</h5>
                                                                                                                                                                  <button
                                                                                                                                                                    type="button"
                                                                                                                                                                    class="btn-close"
                                                                                                                                                                    data-bs-dismiss="modal"
                                                                                                                                                          ...
                                                                                                                                                          <div class="modal fade" id="MODAL9" tabindex="-1" aria-hidden="true">
                                                                                                                                                                                  <div class="modal-dialog modal-lg" role="document">
                                                                                                                                                                                    <div class="modal-content">
                                                                                                                                                                                      <div class="modal-header">
                                                                                                                                                                                        <h5 class="modal-title" id="exampleModalLabel3"><span class="tf-icons bx bxs-graduation mx-2"></span>&nbsp; Escolaridade</h5>
                                                                                                                                                                                        <button
                                                                                                                                                                                          type="button"
                                                                                                                                                                                          class="btn-close"
                                                                                                                                                                                          data-bs-dismiss="modal"
                                                                                                                                                                                ...
                                                                                                                                                                                <div class="modal fade" id="MODAL10" tabindex="-1" aria-hidden="true">
                                                                                                                                                                                                        <div class="modal-dialog modal-lg" role="document">
                                                                                                                                                                                                          <div class="modal-content">
                                                                                                                                                                                                            <div class="modal-header">
                                                                                                                                                                                                              <h5 class="modal-title" id="exampleModalLabel3">  <span class="tf-icons bx bx-line-chart mx-2 "></span>&nbsp; Dificuldade</h5>
                                                                                                                                                                                                              <button
                                                                                                                                                                                                                type="button"
                                                                                                                                                                                                                class="btn-close"
                                                                                                                                                                                                                data-bs-dismiss="modal"
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            <div class="modal-body">
                                                                                                                                                                                                              <div class="row">
                                                                                                                                                                                                                <div class="col mb-3 d-flex align-items-center">
                                                                                                                                                                                                            <input type="text" style="font-style: italic;" class="form-control col mr-2" placeholder="Digite aqui e clique em buscar..." />
                                                                                                                                                                                                            <button type="button" class="btn btn-primary ml-3">
                                                                                                                                                                                                              <span class="tf-icons bx bx-search-alt-2 mx-2 "></span>&nbsp; Buscar
                                                                                                                                                                                                            </button>
                                                                                                                                                                                                          </div>
                      ...
                      <h6> <i>*Clique para remover um item selecionado.</i> </h6>                                                                                                                                                                                </div>  </div>
                        <div id="conteudoSelecionado"></div>
                        <!--/ Horizontal -->
    ...
    <script src="../assets/vendor/js/disciplina_busca_questoes_filtro.js"></script>
    <script src="../assets/vendor/js/assunto_busca_questoes_filtro.js"></script>
