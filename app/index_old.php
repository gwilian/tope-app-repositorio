      ...
      <div class="col-lg-8 mb-4 order-0">
        <div class="card">
          <div class="d-flex align-items-end row">
            <div class="col-sm-7">
              <div class="card-body">
                <h5 class="card-title text-primary">Bem Vindo, <?php echo "$user_tp"; ?>!😉</h5>
                <font class="mb-4">
                "A possibilidade de realizarmos um sonho é o que torna a vida interessante." ~ Paulo Coelho <br>
                </font>
<p></p>
            ...
            <div class="col-sm-5 text-center text-sm-left">
              <div class="card-body pb-0 px-0 px-md-4">
                <img
                src="../assets/img/illustrations/conhecimento.gif"
                height="140"
                alt="View Badge User"
                data-app-dark-img="illustrations/conhecimento.gif"
                data-app-light-img="illustrations/conhecimento.gif"
                />
              </div>
            </div>
          </div>
              ...
              <div class="d-flex justify-content-between flex-sm-row flex-column gap-2">
                <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                  <div class="card-title">
                    <h5 class="text-nowrap mb-2">questões</h5>
                    <span class="badge bg-label-warning rounded-pill">7 dias</span>
                  </div>
      ...
      <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
        <div class="card">
          <div class="row row-bordered g-0">
            <div class="col-md-8">
              <h5 class="card-header m-0 me-2 pb-3">Questões (Acertos x Erros)</h5>
              ...
              <div class="card-body">
                <div class="text-center">
                  ...
                  <div class="dropdown-menu dropdown-menu-end" aria-labelledby="growthReportId">
                    <a class="dropdown-item" href="javascript:void(1);">Sem mais opções</a>
            ...
            <div class="text-center fw-semibold pt-3 mb-2">Hoje: <?php $result->ResultadoHoje($ano . '-' . $mes . '-' . $dia, $id_user); ?> questões</div>

            <div class="d-flex px-xxl-4 px-lg-2 p-4 gap-xxl-3 gap-lg-1 gap-3 justify-content-between">
              <div class="d-flex">
                <div class="me-2">
                  <span class="badge bg-label-primary p-2"><i class="bx bx-check text-primary"></i></span>
                </div>
                <div class="d-flex flex-column">
                  <small>Acertos</small>
                  <h6 class="mb-0"><?php $result->Resultado($ano . '-' . $mes . '-' . $dia, 'Acertou', $id_user); ?> </h6>
                </div>
              </div>
              <div class="d-flex">
                <div class="me-2">
                  <span class="badge bg-label-danger p-2"><i class="bx bx-x text-danger"></i></span>
                </div>
                <div class="d-flex flex-column">
                  <small>Erros</small>
                  <h6 class="mb-0"><?php $result->Resultado($ano . '-' . $mes . '-' . $dia, 'Errou', $id_user); ?></h6>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="col-md-6 col-lg-4 order-2 mb-4">
      <div class="card h-100">
        <div class="card-header d-flex align-items-center justify-content-between">
          <h5 class="card-title m-0 me-2">Quadro (resumo)</h5>
          <div class="dropdown">
            <button
            class="btn p-0"
            type="button"
          ...
          <div class="dropdown-menu dropdown-menu-end" aria-labelledby="transactionID">
            <a class="dropdown-item" href="javascript:void(0);">sem outras opções</a>
        ...
        <ul class="p-0 m-0">
          <li class="d-flex mb-4 pb-1">
            ...
            <div  class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              <div class="me-2">
              <a href="a/erros_acertos.php?status=errou"> <small class="text-muted d-block mb-1">Questões/</small>
                <h6 class="mb-0">total geral</h6></a>
              </div>
              <div class="user-progress d-flex align-items-center gap-1">
                <h6 class="mb-0"> <?php $result->ResultadoGeral($id_user); ?></h6>
          ...
          <li class="d-flex mb-4 pb-1">
            <div class="avatar flex-shrink-0 me-3">
              <img src="../assets/img/icons/unicons/trofeu.png" alt="User" class="rounded" />
            </div>
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              <div class="me-2">
                <small class="text-muted d-block mb-1">Questões/</small>
                <h6 class="mb-0">pontuação</h6>
              </div>
              <div class="user-progress d-flex align-items-center gap-1">
                <h6 class="mb-0" id="pontuacao">0</h6>
                <span class="text-muted"></span>
              </div>
            </div>
          </li>
          <li class="d-flex mb-4 pb-1">
            <div class="avatar flex-shrink-0 me-3">
              <img src="../assets/img/icons/unicons/ok.png" alt="User" class="rounded" />
            </div>
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              <div class="me-2">
                <small class="text-muted d-block mb-1">Materiais/</small>
                <h6 class="mb-0">acertos</h6>
              </div>
              <div class="user-progress d-flex align-items-center gap-1">
                <h6 class="mb-0" id="acerto"> <?php $result->ResultadoTotal("Acertou", $id_user); ?></h6>
                <span class="text-muted"></span>
              </div>
            </div>
          </li>
          <li class="d-flex mb-4 pb-1">
            <div class="avatar flex-shrink-0 me-3">
              <img src="../assets/img/icons/unicons/error.png" alt="User" class="rounded" />
            </div>
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              <div class="me-2">
                <small class="text-muted d-block mb-1">Tasks/</small>
                <h6 class="mb-0">erros</h6>
              </div>
              <div class="user-progress d-flex align-items-center gap-1">
                <h6 class="mb-0" id="erro"><?php $result->ResultadoTotal("Errou", $id_user); ?></h6>
                <span class="text-muted"></span>
              </div>
            </div>
          </li>
...
<!-- Page JS -->
<script src="../assets/js/dashboards-analytics.php"></script>



<script>
  // Obtenha os elementos HTML pelos seus IDs
  var pontuacaoElement = document.getElementById('pontuacao');
  var acertoElement = document.getElementById('acerto');
  var erroElement = document.getElementById('erro');

  // Obtenha os valores dos acertos e erros convertendo-os para números
  var acertos = parseInt(acertoElement.textContent);
  var erros = parseInt(erroElement.textContent);

  // Calcule a pontuação subtraindo o número de erros dos acertos
  var pontuacao = acertos - erros;

  // Atualize o valor da pontuação no elemento HTML
