...
<div class="container">
  <div class="row px-4">
    <div class="col-md-4 mb-4">
      <div class="card small"><a href="questoes_filtro.php?q=1">
        <img class="card-img-top" src="../assets/img/backgrounds/2_QUESTAO.png" alt="Card image cap" />
        <div class="card-body">
          <h5 class="card-title">Enem e vestibulares</h5>
          <p class="card-text">Desafie-se e desenvolva sua capacidade de raciocínio resolvendo questões, consolidando seus conhecimentos e testando sua performance em atividades estimulantes. &nbsp &nbsp &nbsp &nbsp &nbsp. </p>
        </div>
      </div>
    </div></a>

    <div class="col-md-4 mb-4">
      <div class="card small"><a href="questoes_filtro.php?q=2">
        <img class="card-img-top" src="../assets/img/backgrounds/1_QUESTAO.png" alt="Card image cap" />
        <div class="card-body">
          <h5 class="card-title">Exame de ordem</h5>
          <p class="card-text">
            Primeiramente, a aprovação na OAB é um requisito indispensável para quem deseja exercer a advocacia. É por meio da OAB que se tem acesso ao mercado de trabalho e se pode atuar na área jurídica de forma legal e reconhecida.
          </p>
        </div>
      </div>
    </div></a>
    ...
    <div class="col-md-4 mb-4">
      <div class="card small"><a href="questoes_filtro.php?q=3">
        <img class="card-img-top" src="../assets/img/backgrounds/3_QUESTAO.png" alt="Card image cap" />
        <div class="card-body">
          <h5 class="card-title">Concursos</h5>
          <p class="card-text">
            Estudar para concursos é uma oportunidade única de alcançar a estabilidade financeira e profissional, além de se destacar no mercado de trabalho. Dedique-se aos estudos e abra as portas para uma carreira de sucesso.
          </p>
        </div>
      </div>
    </div>
            ...
            <form class="" action="a/sucess.php" method="post">
              <input type="hidden" id="tipo" value="2" name="idpage">
                <input type="hidden" id="tipo" value="<?php echo $id_user; ?>" name="usuariocaderno">

            <div class="modal fade" id="basicModal" tabindex="-1" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">Novo caderno</h5>
                    <button
                      type="button"
                      class="btn-close"
                      data-bs-dismiss="modal"
                  ...
                  <div class="modal-body">
                    <div class="row">
                      <div class="col mb-3">
                        <label for="nameBasic" class="form-label">Nome do caderno</label>
                        <input type="text" id="nameBasic" name="caderno" class="form-control" placeholder="Meu Caderno.." />
                      </div>
                    </div>
                    <div class="row g-2">
                      <div class="col mb-0">
                        <label for="emailBasic" class="form-label">Descrição</label>
                        <textarea  class="form-control" id="emailBasic" name="descricao" rows="4"></textarea>
                      </div>
