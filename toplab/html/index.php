        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
             ...
             <li class="menu-item">
              <a href="robo_questoes.php" class="menu-link">
                <i class="menu-icon tf-icons bx bxs-data"></i>
                <div data-i18n="Analytics">Robô de questões 1.0</div>
              </a>
            </li>
                       ...
                       <div class="card p-3">
                         <figure class="p-3 mb-0">
                           <blockquote class="blockquote">
                             <p>Total de questões cadastradas na plataforma:</p>
                           </blockquote>
...
<br>
                       <div class="card p-3">
                         <figure class="p-3 mb-0">
                           <blockquote class="blockquote">
                             <p>Questões aprovadas ✅</p>
                           </blockquote>

                            <h3><?php
                            $c1 = new Questao;
                            $c1->ContarQuestaoAprovado();
                            ?></h3>
